...
public class GetOvelappingRels {
	...
	/****************************************************************************/
	  ...
	  public static final ArrayList<Relation> loadRelationsFromFilesWithFunctionality(String file, boolean skipFirstLine, int columnRelation, int columnDirectFunc, int columnInvFunc) throws Exception{
		...
		while ((line = pairReader.readLine()) != null) {
				...
				Relation r=(functOfDirect>=functOfInverse)?new Relation(relation,true, functOfDirect, functOfInverse):new Relation(relation,false, functOfInverse, functOfDirect);
		...
		/** EXTRACT ALL PAIRS R(X,Y) FOR A GIVEN R **/
	  	/****************************************************************************/
	  public static final void twoStepExtraction(Relation r, KB kb, String prefixTarget, String fileWithSubjects,  String fileWithPairs) throws Exception{
			extractSubjects(r, kb, prefixTarget, fileWithSubjects);
			//extractPairsForSubjects(r, kb, fileWithSubjects, fileWithPairs);
		}
		
		public static final void extractSubjects(Relation r, KB kb, String prefixTarget, String fileWithSubjects) throws Exception{
			
			
			System.out.println("Extract subjects for "+r);
			...
			BufferedWriter writer  = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(fileWithSubjects), "UTF-8")); 
		   ...
		   System.out.println("				.... finished extracting subjects for "+r);
		}
	 ...
	 public static void main(String[] args) throws Exception{
		...
		String fileWithPairs=tmpDir+"tmp.txt";
